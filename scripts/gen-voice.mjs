...
const LINES = [
  ...
  { file: 'voice-on',
    say: '好,我會把經文唸出來。' },
  /* ── 牧場旁白(2026-08-25 使用者拍板「旁白補強」;不是經文,曉臻同聲=全站一個嗓音)── */
  { file: 'walk-start',
    say: '出發囉!附近有小羊在等你。記得抬頭看路,慢慢走。' },
  { file: 'beast-fight',
    say: '小羊被野獸叼住了!勇敢一點,把牠救回來!' },
  /* ── 🏆 羊1 里程碑金句(2026-08-26;10/25/50/75 四個台階,100 隻沿用既有 luke15-6)──
     ★ 五個台階=五句**不同**的經文,刻意避開每抓一隻都會唸的 路 15:5,
       否則走到台階時聽到的還是同一句 = 慶祝感歸零。
     ★ 全部用 cuv MCP 逐句查驗過和合本原文(2026-08-26);出處用中文數字寫法。 */
  { file: 'luke15-4',
